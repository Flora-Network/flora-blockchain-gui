...
const url = 'https://floracloin.farm';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Chia Network/Flora Team</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Chia-Network/flora-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
